...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit',
        href: `/backoffice/departments/${props.department.id}/edit`,
    },
];
...
const form = useForm({
    ...
    budget_amount: props.department.budget_amount || 0,
    description: props.department.description || '',
});

const submit = () => {
    form.put(`/backoffice/departments/${props.department.id}`);
};
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold tracking-tight">Edit Department</h2>
